...
public class ProveedoresBDD {
	public ArrayList<Proveedor> buscar(String subcadena) throws KrakeDevException{
		...
		try {
			...
			ps=con.prepareStatement("select identificador,tipo_documento,td.descripcion,nombre,telefono,correo,ubicacion "
					+ "from proveedores prov, tipo_documento td "
					+ "where prov.tipo_documento = td.codigo_documento "
	...
	public void insertar(Proveedor proveedor) throws KrakeDevException {
	    ...
	    try {
	        con = ConexionBDD.obtenerConexion();
	        String sql = "INSERT INTO proveedores (identificador, tipo_documento, nombre, telefono, correo, ubicacion) "
	                   + "VALUES (?, ?, ?, ?, ?, ?)";
